...
<div class="container">
		...
		<div>
	    <form:input type="text" class="form-control mb-4 col-4" id="cost" path="paidCost" autocomplete="off" />
	    </div>
		...
		<p><br>
			<a href="${pageContext.request.contextPath}/paid" class="btn btn-danger btn-sm mb-3">Back to Paid List</a>
		</p>
</div>
</body>
